"""Orquestador v2: usa el split fijo por clustering quimico (mismo para
TODAS las corridas de v2), preprocesamiento por bloques, preentrenamiento
opcional, y registra el protocolo completo (semillas, split usado,
hiperparametros, cantidad de pares por fold, version de librerias) junto
a los resultados -- para que cualquiera pueda reproducir exactamente la
misma corrida.
"""
