"""Utilidades compartidas de preprocesamiento y entrenamiento (regla 9: todo
preprocesamiento/normalizacion/seleccion de features/ajuste de
hiperparametros se hace EXCLUSIVAMENTE con datos de entrenamiento).

Cada metodo (los 3 scripts metodoX_*.py) importa esto y solo aporta su
propia arquitectura de red (nn.Module) y sus hiperparametros puntuales.
"""
