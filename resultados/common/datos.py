"""Carga uniforme de DAVIS y KIBA reales (ya descargados via PyTDC por
descargar_datos.py) y calculo/cacheo de los descriptores fisicoquimicos
compartidos (regla 3 y 11: mismos bancos de datos y mismos descriptores
para los 3 metodos).
"""
