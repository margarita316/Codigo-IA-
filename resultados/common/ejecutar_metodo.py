"""Orquestador generico compartido por los 3 scripts de metodo. Cada
metodoX_*.py solo define la arquitectura del modelo (crear_modelo) y sus
hiperparametros; este modulo se encarga de: cargar DAVIS/KIBA, verificar
duplicados, correr la CV cold-drug 5x10, entrenar/evaluar cada fold y
guardar resultados por-fold + resumen (media +/- desviacion estandar).
"""
