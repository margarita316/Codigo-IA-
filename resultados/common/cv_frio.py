"""Validacion cruzada 'cold-drug' repetida (5 folds x 10 repeticiones = 50
particiones). 'Cold-drug' = un mismo Drug_ID nunca aparece a la vez en train
y en test: el modelo siempre se evalua sobre farmacos que no vio entrenar.

Tambien incluye la verificacion automatica pedida (regla 10): ausencia de
farmacos compartidos entre train/test, y deteccion de pares/SMILES/secuencias
duplicados en el dataset antes de particionar.
"""
