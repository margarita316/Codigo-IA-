"""Preprocesamiento v2: seleccion de caracteristicas POR BLOQUE (no de
forma global) para no romper el significado de "bloque" que necesitan los
metodos 1 y 3 (cada bloque es un tipo de descriptor real: RDKit, Morgan,
AAC, DPC, CTD, posicional). Todo ajustado exclusivamente con datos de
train (regla 9), igual que en v1.

Tambien define la configuracion de ablacion: que bloques entran en cada
variante (base / +Morgan / +Morgan+posicional / completa con
preentrenamiento).
"""
